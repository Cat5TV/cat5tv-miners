...
echo "$dest/software/$name/xmrig-nvidia --algo=cryptonight --variant=xtl -o communitypool.stellite.cash:\$port -u $wallet -p cat5tv:x -k --donate-level=1" >> $dest/$name.sh
